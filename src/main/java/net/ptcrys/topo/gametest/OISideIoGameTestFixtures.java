 ...
 *
 * <p>
 * 门控与 {@link OIScalarGameTestFixtures#enabled()} 同源;注册须在 {@code Machines.freeze()} 之前
 * (由 {@code OfficialOIPlugin#registerMachines} 调用)。
 */
public final class OISideIoGameTestFixtures {

    public static final int ENERGY_CAPACITY = 100;

    private static MachineDefinition sideIoBuffer;

    private OISideIoGameTestFixtures() {}
    ...
    public static void initMachines() {
        ...
        sideIoBuffer = OfficialOIPlugin.INSTANCE.machine().machine("gametest_side_io_buffer")

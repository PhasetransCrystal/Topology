 ...
 * ({@code BuiltinOIMachines} 等正式内容)可以随版本随意调平衡,不影响测试精度。
 *
 * <p>
 ...
 * 单独打开。注册分两段进引导:配方类型在 {@code OIPluginEngine#bootstrapRecipe} 冻结前,机器在
 * {@code OIPluginEngine#bootstrapMachine} 冻结前;两段都不得在 {@link #enabled()} 为 false 时调用。
 *
 * <p>
 * 固定数值(测试断言依赖,勿调):
 * <ul>
 ...
 * </ul>
 */
public final class OIScalarGameTestFixtures {
    ...
    private static OIRecipeType<OIRecipe> energyGeneratorType;
    private static OIRecipeType<OIRecipe> advancedGeneratorType;
    private static OIRecipeType<OIRecipe> boilerType;
    private static OIRecipeType<OIRecipe> electricBoilerType;
    private static OIRecipeType<OIRecipe> historyGateFallbackType;
    ...
    private OIScalarGameTestFixtures() {}
    ...
    /** 在 {@code OIRecipeTypes.freeze()} 之前调用。 */
    public static void initRecipeTypes() {
        if (energyGeneratorType != null) {
            return;
        }
        RecipeDomainRegistration recipe = OfficialOIPlugin.INSTANCE.recipe();
    ...
    public static void initRecipes() {
        ...
        ScalarRecipeCapability advancedEnergy = BuiltinOIResourceIntegrations.ADVANCED_ENERGY.recipeCapability();
    ...
    public static void initMachines() {
        ...
        energyGenerator = OfficialOIPlugin.INSTANCE.machine().machine("gametest_energy_generator")
                ...
                .build();
        advancedGenerator = OfficialOIPlugin.INSTANCE.machine().machine("gametest_advanced_energy_generator")
                .block(OrientedMachineBlock::new)
                .blockEntity(MachineBlockEntity::new)
                ...
                .build();
        boiler = OfficialOIPlugin.INSTANCE.machine().machine("gametest_boiler")
                .block(OrientedMachineBlock::new)
                .blockEntity(MachineBlockEntity::new)
                ...
                .build();
        electricBoiler = OfficialOIPlugin.INSTANCE.machine().machine("gametest_electric_boiler")
                .block(OrientedMachineBlock::new)
                .blockEntity(MachineBlockEntity::new)
                ...
                .build();
        historyGateFallback = OfficialOIPlugin.INSTANCE.machine().machine("gametest_history_gate_fallback")
                .block(OrientedMachineBlock::new)
                .blockEntity(MachineBlockEntity::new)

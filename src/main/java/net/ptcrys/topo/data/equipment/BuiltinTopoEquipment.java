...
import net.ptcrys.topo.data.equipment.common.ArmorEquipment;
import net.ptcrys.topo.data.equipment.common.SurveyorEquipment;
import net.ptcrys.topo.data.equipment.common.ToolEquipment;
import net.ptcrys.topo.data.equipment.common.behavior.RegulatorBehavior;
 ...
 */
public final class BuiltinTopoEquipment {
    ...
    public static final EquipmentDomainRegistration EQUIPMENT = OfficialTopoPlugin.INSTANCE.equipment();
    /**
    ...
    public static final Equipment FORGE_HAMMER = EQUIPMENT.kind("forge_hammer",
            ToolEquipment.builder()
                    ...
                    .extraRecipe((material, entry) -> {
                        if (!material.strategy().forms().contains(BuiltinTopoMaterialForms.INGOT)) {
                            return;
                        }
                        // Deferred: RegisterEvent HIGHEST has not bound ItemEntry yet.
                        var ingot = MaterialHelper.materialItemSupplier(
                                material, BuiltinTopoMaterialForms.INGOT);
                    ...
                    .creativeTab(BuiltinTopoCreativeTabs.EQUIPMENT.getKey())
                    .build());

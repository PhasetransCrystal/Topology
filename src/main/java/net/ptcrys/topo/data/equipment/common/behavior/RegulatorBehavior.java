package net.ptcrys.topo.data.equipment.common.behavior;
...
public final class RegulatorBehavior implements MachineItemBehavior {
    ...
    public InteractionResult useOnMachine(MachineBlockEntity machine, Player player, ItemStack stack,
        ...
        player.sendOverlayMessage((result == WorkMode.HALTED ? BuiltinTopoEquipmentLang.EQUIPMENT_REGULATOR_HALTED : BuiltinTopoEquipmentLang.EQUIPMENT_REGULATOR_RESUMED).getComponent());

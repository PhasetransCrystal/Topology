...
import net.ptcrys.topo.data.equipment.EquipmentTooltipLine;
...
public abstract class StandardEquipmentBase implements EquipmentStrategy {
     ...
     * product table / equipment domain — do not hard-bind OfficialTopoPlugin here).
     */
    ...
    private void emitAssemblyRecipe(Material material, ItemEntry<Item> entry) {
        ...
        var shaped = BuiltinTopoRecipeTypes.CRAFTING_SHAPED

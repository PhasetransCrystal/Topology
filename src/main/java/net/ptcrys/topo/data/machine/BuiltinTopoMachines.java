...
import net.ptcrys.topo.data.machine.common.component.PreviewRecipeModifierComponent;
...
public final class BuiltinTopoMachines {
    ...
    private static MachineDefinition combustionGenerator(MachineTier tier) {
        return base(
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        OUTPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.COMBUSTION_GENERATOR))
                .component(recipeUi())
    ...
    private static MachineDefinition boiler(MachineTier tier) {
        return base("boiler", "Boiler", "锅炉", "boiler", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        OUTPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.BOILER))
                .component(recipeUi())
    ...
    private static MachineDefinition resistiveHeater(MachineTier tier) {
        return base("resistive_heater", "Resistive Heater", "电阻加热器", "electric_boiler", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        OUTPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.RESISTIVE_HEATER))
                .component(recipeUi())
    ...
    private static MachineDefinition componentProcessor(MachineTier tier) {
        return base(
                ...
                .component(Ports.item(
                        ...
                        1,
                        PortAccess.dieSlot(),
                        ResourceFilterHelper.itemTag(BuiltinTopoProcessDies.DIES)))
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.COMPONENT_PROCESSOR))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.EnergyTierModifier.of(tier))
                .build();
    }
    ...
    private static MachineDefinition wireMill(MachineTier tier) {
        return base("wire_mill", "Wire Mill", "线材轧机", "bender", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.WIRE_MILL))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.EnergyTierModifier.of(tier))
                .build();
    }
    ...
    private static MachineDefinition energyCompressor(MachineTier tier) {
        return base(
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        OUTPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.ENERGY_COMPRESSOR))
                .component(recipeUi())
    ...
    private static MachineDefinition airCollector(MachineTier tier) {
        return base("air_collector", "Air Collector", "空气收集器", "air_collector", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.AIR_COLLECTOR))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.EnergyTierModifier.of(tier))
                .build();
    }
    ...
    private static MachineDefinition macerator(MachineTier tier) {
        return base("macerator", "Macerator", "粉碎机", "macerator", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.MACERATOR))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.EnergyTierModifier.of(tier))
    ...
    private static MachineDefinition fineGrinder(MachineTier tier) {
        return base("fine_grinder", "Fine Grinder", "精细研磨机", "cutting_mill", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.FINE_GRINDER))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.EnergyTierModifier.of(tier))
                .build();
    }
    ...
    private static MachineDefinition oreWasher(MachineTier tier) {
        return base("ore_washer", "Ore Washer", "洗矿机", "ore_washer", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.ORE_WASHER))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.EnergyTierModifier.of(tier))
                .build();
    }
    ...
    private static MachineDefinition electricFurnace(MachineTier tier) {
        return base("electric_furnace", "Electric Furnace", "电炉", "electric_furnace", tier)
                ...
                .component(recipeLogic(
                        BuiltinTopoRecipeTypes.ELECTRIC_FURNACE,
                        BuiltinTopoRecipeTypes.BLAST_FURNACE))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.EnergyTierModifier.of(tier))
                .build();
    }
    ...
    private static MachineDefinition industrialCombustionFurnace(MachineTier tier) {
        return base(
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.INDUSTRIAL_COMBUSTION_FURNACE))
                .component(recipeUi())
    ...
    private static MachineDefinition chemicalReactor(MachineTier tier) {
        ...
        return base("chemical_reactor", "Chemical Reactor", "化学反应器", "chemical_reactor", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.CHEMICAL_REACTOR))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.EnergyTierModifier.of(tier))
    ...
    private static MachineDefinition mixingTank(MachineTier tier) {
        return base("mixing_tank", "Mixing Tank", "混合槽", "mixing_tank", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.MIXING_TANK))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.EnergyTierModifier.of(tier))
                .build();
    }
    ...
    private static MachineDefinition electrolyzer(MachineTier tier) {
        return base("electrolyzer", "Electrolyzer", "电解槽", "electrolyzer", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.ELECTROLYZER))
                .component(recipeUi())
    ...
    private static MachineDefinition evaporator(MachineTier tier) {
        return base("evaporator", "Evaporator", "蒸发器", "evaporator", tier)
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.EVAPORATOR))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.HeatTierModifier.of(tier))
                .build();
    }
    ...
    private static MachineDefinition highPressureCrystallizer(MachineTier tier) {
        return base(
                ...
                .component(Ports.scalar(
                        ...
                        scalarCapacity(tier),
                        INPUT))
                .component(recipeLogic(BuiltinTopoRecipeTypes.HIGH_PRESSURE_CRYSTALLIZER))
                .component(recipeUi())
                .component(PerformanceRecipeModifiers.AdvancedEnergyTierModifier.of(tier))
                .build();
    }
    ...
    private static Machines.Builder base(
        ...
        return OfficialTopoPlugin.INSTANCE.machine().machine(path)
                ...
                .render(BuiltinTopoMachineRenderTypes.SHELL_OVERLAY.overlay(
                        tier.shellMaterial(),
    ...
    private static Identifier texture(String machine, String name) {
        return OfficialTopoPlugin.INSTANCE.machine().id("block/machines/" + machine + "/" + name);
    }

    private static ComponentMount<RecipeLogic> recipeLogic(TopoRecipeType<?>... recipeTypes) {

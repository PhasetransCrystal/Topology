 ...
 */
public final class BuiltinTopoMeMachines {
     ...
     */
    private static final Identifier ME_INTERFACE_FRONT = OfficialTopoPlugin.INSTANCE.machine().id("block/machines/hatch/me_interface_front");
    ...
    public static final MachineDefinition ME_DRAWING_ITEM_INPUT_BUS = OfficialTopoPlugin.INSTANCE.machine().machine("me_drawing_item_input_bus")
            .block(BuiltinTopoMeMachines::ctmHatchBlock)
    ...
    public static final MachineDefinition ME_DRAWING_FLUID_INPUT_HATCH = OfficialTopoPlugin.INSTANCE.machine().machine("me_drawing_fluid_input_hatch")
            .block(BuiltinTopoMeMachines::ctmHatchBlock)
            .blockEntity(MachineBlockEntity::new)
    ...
    public static final MachineDefinition ME_DIRECT_ITEM_INPUT_BUS = OfficialTopoPlugin.INSTANCE.machine().machine("me_direct_item_input_bus")
            .block(BuiltinTopoMeMachines::ctmHatchBlock)
            .blockEntity(MachineBlockEntity::new)
            ...
            .component(AeStockingItemPort.mount(9).role(BuiltinTopoPartRoles.ITEM_INPUT))
            .component(AeConfigPageUi.mount(AeStockingItemPort.AE_STOCKING_ITEM_PORT))
            .build();

    public static final MachineDefinition ME_DIRECT_FLUID_INPUT_HATCH = OfficialTopoPlugin.INSTANCE.machine().machine("me_direct_fluid_input_hatch")
            .block(BuiltinTopoMeMachines::ctmHatchBlock)
            .blockEntity(MachineBlockEntity::new)
            ...
            .render(meHatchRender(HATCH_PIPE_IN, ME_INTERFACE_FRONT))
            .component(AeGridNode.mount(0.5))
            .component(AeStockingFluidPort.mount(9).role(BuiltinTopoPartRoles.FLUID_INPUT))
            .component(AeConfigPageUi.mount(AeStockingFluidPort.AE_STOCKING_FLUID_PORT))
            .build();

    public static final MachineDefinition ME_PATTERN_PROVIDER = OfficialTopoPlugin.INSTANCE.machine().machine("me_pattern_provider")
            .block(BuiltinTopoMeMachines::ctmHatchBlock)
            .blockEntity(MachineBlockEntity::new)
     ...
     */
    public static final MachineDefinition ME_EXPORT_HATCH = OfficialTopoPlugin.INSTANCE.machine().machine("me_export_hatch")
            .block(BuiltinTopoMeMachines::ctmHatchBlock)
            .blockEntity(MachineBlockEntity::new)
            ...
            .component(AeGridNode.mount(1.0))
            .component(AeItemBufferPort.mount(36).role(BuiltinTopoPartRoles.ITEM_OUTPUT))
            .component(AeFluidBufferPort.mount(9).role(BuiltinTopoPartRoles.FLUID_OUTPUT))
    ...
    private static MachineBlockRenderUse<CtmHatchRenderType.Data> meHatchRender(Identifier pipe, Identifier icon) {
        return BuiltinTopoMachineRenderTypes.CTM_HATCH.hatch(

 ...
 */
public final class BuiltinTopoMachineCraftingRecipes {
    ...
    private BuiltinTopoMachineCraftingRecipes() {}
    ...
    private static Supplier<Item> mat(net.ptcrys.topo.api.material.Material material, net.ptcrys.topo.api.material.form.MaterialForm form) {
    ...
    private static void shaped(
        ...
        BuiltinTopoRecipeTypes.CRAFTING_SHAPED.recipe(path, result, recipe).unlockedBy(unlock).save();
    }
    ...
    private static void shaped(
                               ...
                               Object... recipe) {
        BuiltinTopoRecipeTypes.CRAFTING_SHAPED.recipe(path, result, count, recipe).unlockedBy(unlock).save();
    }
    ...
    private static ItemEntry<Item> part(String id, String enName, String zhName) {
        ...
        return builder.addTab(BuiltinTopoCreativeTabs.COMPONENTS.getKey()).register();
    }
        ...
        var builder = Topology.REGISTRY.block(id, Block::new)
                ...
                .blockstate(() -> (block, provider) -> provider.generateWithTemplate(
                        ...
                        new TextureMapping()
                                .put(
                                        TextureSlot.SIDE,
                                        new Material(OfficialTopoPlugin.INSTANCE.machine().id(folder + "/side")))
                                .put(
                                        TextureSlot.TOP,
                                        new Material(OfficialTopoPlugin.INSTANCE.machine().id(folder + "/top")))
                                .put(
                                        TextureSlot.BOTTOM,
                                        new Material(
                                                OfficialTopoPlugin.INSTANCE.machine().id(folder + "/bottom")))))
                .item(item -> item.addTab(BuiltinTopoCreativeTabs.COMPONENTS.getKey()));
    ...
    private static void registerStructureCasingRecipes() {
        var nickelDense = mat(BuiltinTopoMaterials.NICKEL, BuiltinTopoMaterialForms.PLATE_DENSE);
        var ironFrame = mat(BuiltinTopoMaterials.IRON, BuiltinTopoMaterialForms.FRAME);
        var nickelBolt = mat(BuiltinTopoMaterials.NICKEL, BuiltinTopoMaterialForms.BOLT);
        shaped(
                "shape/component/dense_structure_casing",
                BuiltinTopoCasingBlocks.DENSE_STRUCTURE_CASING,
                2,
                nickelDense,
                "PBP", "BFB", "PBP",
    ...
    private static void registerMultiblockControllerRecipes() {
        var nickelBolt = mat(BuiltinTopoMaterials.NICKEL, BuiltinTopoMaterialForms.BOLT);
        machine(
                BuiltinTopoControllerMachines.LARGE_GRINDER,
                GRIND_DISC,
                "D D", "DFU", "DBB",
                'D', GRIND_DISC, 'F', blockOf(BuiltinTopoMachines.FINE_GRINDER_T3),
                'U', LUMEN_CORE, 'B', nickelBolt);
    }

    private static void registerPartRecipes() {
        var ironPlate = mat(BuiltinTopoMaterials.IRON, BuiltinTopoMaterialForms.PLATE);
        var ironRod = mat(BuiltinTopoMaterials.IRON, BuiltinTopoMaterialForms.ROD);
        var ironGear = mat(BuiltinTopoMaterials.IRON, BuiltinTopoMaterialForms.GEAR);
        var ironBolt = mat(BuiltinTopoMaterials.IRON, BuiltinTopoMaterialForms.BOLT);
        var ironFrame = mat(BuiltinTopoMaterials.IRON, BuiltinTopoMaterialForms.FRAME);
        var copperPlate = mat(BuiltinTopoMaterials.COPPER, BuiltinTopoMaterialForms.PLATE);
        var copperRod = mat(BuiltinTopoMaterials.COPPER, BuiltinTopoMaterialForms.ROD);
        var copperWire = mat(BuiltinTopoMaterials.COPPER, BuiltinTopoMaterialForms.WIRE_1X);
        var goldPlate = mat(BuiltinTopoMaterials.GOLD, BuiltinTopoMaterialForms.PLATE);
        var goldRod = mat(BuiltinTopoMaterials.GOLD, BuiltinTopoMaterialForms.ROD);
        var goldWire = mat(BuiltinTopoMaterials.GOLD, BuiltinTopoMaterialForms.WIRE_1X);
        var goldWire2 = mat(BuiltinTopoMaterials.GOLD, BuiltinTopoMaterialForms.WIRE_2X);
        var goldWire4 = mat(BuiltinTopoMaterials.GOLD, BuiltinTopoMaterialForms.WIRE_4X);
        var nickelWire = mat(BuiltinTopoMaterials.NICKEL, BuiltinTopoMaterialForms.WIRE_1X);
        var leadPlate = mat(BuiltinTopoMaterials.LEAD, BuiltinTopoMaterialForms.PLATE);
        var tinPlate = mat(BuiltinTopoMaterials.TIN, BuiltinTopoMaterialForms.PLATE);
        var zincPlate = mat(BuiltinTopoMaterials.ZINC, BuiltinTopoMaterialForms.PLATE);
        var redstoneCrude = mat(BuiltinTopoMaterials.REDSTONE, BuiltinTopoMaterialForms.CRUDE_DUST);
        var luminiteGem = mat(BuiltinTopoMaterials.LUMINITE, BuiltinTopoMaterialForms.GEM);
    ...
    private static void registerNativeMachineRecipes() {
        ...
        var nickelBolt = mat(BuiltinTopoMaterials.NICKEL, BuiltinTopoMaterialForms.BOLT);
        var copperWire = mat(BuiltinTopoMaterials.COPPER, BuiltinTopoMaterialForms.WIRE_1X);
        var copperWire4 = mat(BuiltinTopoMaterials.COPPER, BuiltinTopoMaterialForms.WIRE_4X);
        var goldWire2 = mat(BuiltinTopoMaterials.GOLD, BuiltinTopoMaterialForms.WIRE_2X);
        var goldWire8 = mat(BuiltinTopoMaterials.GOLD, BuiltinTopoMaterialForms.WIRE_8X);

        var hullB = MACHINE_HULL_BASIC;
        var hullR = MACHINE_HULL_REINFORCED;
        var hullD = MACHINE_HULL_DENSE;

        machine(BuiltinTopoMachines.COMPONENT_PROCESSOR_T1, FORGE_ANVIL_CORE,
                "WGW", "AHB", " BG",
                'W', copperWire, 'G', ironGear, 'A', FORGE_ANVIL_CORE, 'H', hullB, 'B', ironBolt);
        machine(BuiltinTopoMachines.WIRE_MILL_T1, DRAW_SPOOL,
                "WGW", "DHB", " BG",
                'W', copperWire, 'G', ironGear, 'D', DRAW_SPOOL, 'H', hullB, 'B', ironBolt);
        machine(BuiltinTopoMachines.COMBUSTION_GENERATOR_T1, EMBER_CORE,
                "WGW", "EHB", " BG",
                'W', copperWire, 'G', ironGear, 'E', EMBER_CORE, 'H', hullB, 'B', ironBolt);
        machine(BuiltinTopoMachines.BOILER_T1, EMBER_CORE,
                " F ", "EHB", " B ",
                'F', FLOW_VANE, 'E', EMBER_CORE, 'H', hullB, 'B', ironBolt);
        machine(BuiltinTopoMachines.RESISTIVE_HEATER_T1, GLOW_FILAMENT,
                "WBW", "GHB",
                'W', copperWire, 'B', ironBolt, 'G', GLOW_FILAMENT, 'H', hullB);
        machine(BuiltinTopoMachines.MACERATOR_T1, CRUSH_WHEEL,
                "WGW", "CHB", " BG",
                'W', copperWire, 'G', ironGear, 'C', CRUSH_WHEEL, 'H', hullB, 'B', ironBolt);
        machine(BuiltinTopoMachines.FINE_GRINDER_T1, GRIND_DISC,
                "WGW", "DHB", " BG",
                'W', copperWire, 'G', ironGear, 'D', GRIND_DISC, 'H', hullB, 'B', ironBolt);
        machine(BuiltinTopoMachines.ORE_WASHER_T1, FLOW_VANE,
                "WFW", "BHB", " F ",
                'W', copperWire, 'F', FLOW_VANE, 'B', ironBolt, 'H', hullB);
        machine(BuiltinTopoMachines.ELECTRIC_FURNACE_T1, SINTER_CORE,
                "WBW", "SHB",
                'W', copperWire, 'B', ironBolt, 'S', SINTER_CORE, 'H', hullB);
        machine(BuiltinTopoMachines.AIR_COLLECTOR_T1, FLOW_VANE,
                "WFW", "BHB", " GF",
                'W', copperWire, 'F', FLOW_VANE, 'G', Items.GLASS, 'H', hullB, 'B', ironBolt);

        machine(BuiltinTopoMachines.ENERGY_COMPRESSOR_T2, FOCUS_RING,
                "WBW", "FHS", " B ",
                'W', goldWire2, 'B', nickelBolt, 'F', FOCUS_RING, 'H', hullR, 'S', SIGNAL_CORE);
        machine(BuiltinTopoMachines.INDUSTRIAL_COMBUSTION_FURNACE_T2, CORROSION_LINER,
                "EL ", "BHS", "DB ",
                'E', EMBER_CORE, 'L', CORROSION_LINER, 'B', nickelBolt, 'H', hullR, 'S', SIGNAL_CORE, 'D', HEAT_DUCT);
        machine(BuiltinTopoMachines.CHEMICAL_REACTOR_T2, CORROSION_LINER,
                "WLW", "LHD", "BSB",
                'W', copperWire4, 'L', CORROSION_LINER, 'H', hullR, 'D', HEAT_DUCT, 'B', nickelBolt, 'S', SIGNAL_CORE);
        machine(BuiltinTopoMachines.MIXING_TANK_T2, FLOW_VANE,
                "WFW", "BHB", "LFS",
                'W', copperWire4, 'F', FLOW_VANE, 'B', nickelBolt, 'H', hullR, 'L', CORROSION_LINER, 'S', SIGNAL_CORE);
        machine(BuiltinTopoMachines.EVAPORATOR_T2, HEAT_DUCT,
                "D D", "LHS", "BFB",
                'D', HEAT_DUCT, 'L', CORROSION_LINER, 'H', hullR, 'S', SIGNAL_CORE, 'B', nickelBolt, 'F', FLOW_VANE);
        machine(BuiltinTopoMachines.ELECTROLYZER_T2, FOCUS_RING,
                "W W", "FHL", "BSB",
                'W', goldWire2, 'F', FOCUS_RING, 'H', hullR, 'L', CORROSION_LINER, 'B', nickelBolt, 'S', SIGNAL_CORE);
        machine(BuiltinTopoMachines.HIGH_PRESSURE_CRYSTALLIZER_T3, RESONANCE_CHAMBER,
                "WFW", "RHL", "BNB",
    ...
    private static void registerHigherTier() {
        var nickelBolt = mat(BuiltinTopoMaterials.NICKEL, BuiltinTopoMaterialForms.BOLT);
        var copperWire4 = mat(BuiltinTopoMaterials.COPPER, BuiltinTopoMaterialForms.WIRE_4X);
        var copperWire8 = mat(BuiltinTopoMaterials.COPPER, BuiltinTopoMaterialForms.WIRE_8X);
        var goldWire8 = mat(BuiltinTopoMaterials.GOLD, BuiltinTopoMaterialForms.WIRE_8X);
        var ironRotor = mat(BuiltinTopoMaterials.IRON, BuiltinTopoMaterialForms.ROTOR);
        var hullR = MACHINE_HULL_REINFORCED;
        var hullD = MACHINE_HULL_DENSE;

        higherRotatingT2(BuiltinTopoMachines.COMPONENT_PROCESSOR_T2, FORGE_ANVIL_CORE, hullR, copperWire4, ironRotor, nickelBolt);
        higherRotatingT2(BuiltinTopoMachines.WIRE_MILL_T2, DRAW_SPOOL, hullR, copperWire4, ironRotor, nickelBolt);
        higherRotatingT2(BuiltinTopoMachines.COMBUSTION_GENERATOR_T2, EMBER_CORE, hullR, copperWire4, ironRotor, nickelBolt);
        higherRotatingT2(BuiltinTopoMachines.MACERATOR_T2, CRUSH_WHEEL, hullR, copperWire4, ironRotor, nickelBolt);
        higherRotatingT2(BuiltinTopoMachines.FINE_GRINDER_T2, GRIND_DISC, hullR, copperWire4, ironRotor, nickelBolt);

        machine(BuiltinTopoMachines.BOILER_T2, EMBER_CORE,
                " F ", "EHS", "B B",
                'F', FLOW_VANE, 'E', EMBER_CORE, 'H', hullR, 'S', SIGNAL_CORE, 'B', nickelBolt);
        machine(BuiltinTopoMachines.RESISTIVE_HEATER_T2, GLOW_FILAMENT,
                "WBW", "GHS", " B ",
                'W', copperWire4, 'B', nickelBolt, 'G', GLOW_FILAMENT, 'H', hullR, 'S', SIGNAL_CORE);
        machine(BuiltinTopoMachines.ORE_WASHER_T2, FLOW_VANE,
                "WFW", "BHB", " SF",
                'W', copperWire4, 'F', FLOW_VANE, 'B', nickelBolt, 'H', hullR, 'S', SIGNAL_CORE);
        machine(BuiltinTopoMachines.ELECTRIC_FURNACE_T2, SINTER_CORE,
                "WBW", "CHS", " B ",
                'W', copperWire4, 'B', nickelBolt, 'C', SINTER_CORE, 'H', hullR, 'S', SIGNAL_CORE);
        machine(BuiltinTopoMachines.AIR_COLLECTOR_T2, FLOW_VANE,
                "WFW", "BHB", "GSF",
                'W', copperWire4, 'F', FLOW_VANE, 'G', Items.GLASS, 'H', hullR, 'S', SIGNAL_CORE, 'B', nickelBolt);

        higherRotatingT3(BuiltinTopoMachines.COMPONENT_PROCESSOR_T3, FORGE_ANVIL_CORE, hullD, copperWire8, ironRotor, nickelBolt);
        higherRotatingT3(BuiltinTopoMachines.WIRE_MILL_T3, DRAW_SPOOL, hullD, copperWire8, ironRotor, nickelBolt);
        higherRotatingT3(BuiltinTopoMachines.COMBUSTION_GENERATOR_T3, EMBER_CORE, hullD, copperWire8, ironRotor, nickelBolt);
        higherRotatingT3(BuiltinTopoMachines.MACERATOR_T3, CRUSH_WHEEL, hullD, copperWire8, ironRotor, nickelBolt);
        higherRotatingT3(BuiltinTopoMachines.FINE_GRINDER_T3, GRIND_DISC, hullD, copperWire8, ironRotor, nickelBolt);

        machine(BuiltinTopoMachines.BOILER_T3, EMBER_CORE,
                " F ", "EHL", "B B",
                'F', FLOW_VANE, 'E', EMBER_CORE, 'H', hullD, 'L', LUMEN_CORE, 'B', nickelBolt);
        machine(BuiltinTopoMachines.RESISTIVE_HEATER_T3, GLOW_FILAMENT,
                "WBW", "GHL", " B ",
                'W', copperWire8, 'B', nickelBolt, 'G', GLOW_FILAMENT, 'H', hullD, 'L', LUMEN_CORE);
        machine(BuiltinTopoMachines.ORE_WASHER_T3, FLOW_VANE,
                "WFW", "BHB", " LF",
                'W', copperWire8, 'F', FLOW_VANE, 'B', nickelBolt, 'H', hullD, 'L', LUMEN_CORE);
        machine(BuiltinTopoMachines.ELECTRIC_FURNACE_T3, SINTER_CORE,
                "WBW", "CHL", " B ",
                'W', copperWire8, 'B', nickelBolt, 'C', SINTER_CORE, 'H', hullD, 'L', LUMEN_CORE);
        machine(BuiltinTopoMachines.AIR_COLLECTOR_T3, FLOW_VANE,
                "WFW", "BHB", "GLF",
                'W', copperWire8, 'F', FLOW_VANE, 'G', Items.GLASS, 'H', hullD, 'L', LUMEN_CORE, 'B', nickelBolt);

        machine(BuiltinTopoMachines.ENERGY_COMPRESSOR_T3, FOCUS_RING,
                "WBW", "FHL", " B ",
                'W', goldWire8, 'B', nickelBolt, 'F', FOCUS_RING, 'H', hullD, 'L', LUMEN_CORE);
        machine(BuiltinTopoMachines.INDUSTRIAL_COMBUSTION_FURNACE_T3, CORROSION_LINER,
                "EL ", "BHU", "DB ",
                'E', EMBER_CORE, 'L', CORROSION_LINER, 'B', nickelBolt, 'H', hullD, 'U', LUMEN_CORE, 'D', HEAT_DUCT);
        machine(BuiltinTopoMachines.CHEMICAL_REACTOR_T3, CORROSION_LINER,
                "WLW", "LHD", "BUB",
                'W', copperWire8, 'L', CORROSION_LINER, 'H', hullD, 'D', HEAT_DUCT, 'B', nickelBolt, 'U', LUMEN_CORE);
        machine(BuiltinTopoMachines.MIXING_TANK_T3, FLOW_VANE,
                "WFW", "BHB", "LFU",
                'W', copperWire8, 'F', FLOW_VANE, 'B', nickelBolt, 'H', hullD, 'L', CORROSION_LINER, 'U', LUMEN_CORE);
        machine(BuiltinTopoMachines.EVAPORATOR_T3, HEAT_DUCT,
                "D D", "LHU", "BFB",
                'D', HEAT_DUCT, 'L', CORROSION_LINER, 'H', hullD, 'U', LUMEN_CORE, 'B', nickelBolt, 'F', FLOW_VANE);
        machine(BuiltinTopoMachines.ELECTROLYZER_T3, FOCUS_RING,
                "W W", "FHL", "BUB",
    ...
    private static void registerMachineProcessRecipes() {
        ...
        ScalarRecipeCapability advEnergy = BuiltinTopoResourceIntegrations.ADVANCED_ENERGY.recipeCapability();
        FluidRecipeCapability fluids = BuiltinTopoResourceIntegrations.FLUID.recipeCapability();

        BuiltinTopoRecipeTypes.COMPONENT_PROCESSOR.recipe("machine_hull_reinforced_press")
                .input(items.in(deferred(MACHINE_HULL_BASIC), 1))
                .input(items.in(BuiltinTopoMaterials.NICKEL, BuiltinTopoMaterialForms.PLATE, 4))
                .input(items.in(BuiltinTopoMaterials.NICKEL, BuiltinTopoMaterialForms.BOLT, 4))
                ...
                .save();
        BuiltinTopoRecipeTypes.COMPONENT_PROCESSOR.recipe("machine_hull_dense_press")
                .input(items.in(deferred(MACHINE_HULL_REINFORCED), 1))
                .input(items.in(BuiltinTopoMaterials.NICKEL, BuiltinTopoMaterialForms.PLATE_DENSE, 4))
        ...
        BuiltinTopoRecipeTypes.CHEMICAL_REACTOR.recipe("nexus_core_etch")
                .input(items.in(deferred(NEXUS_CORE_BLANK), 1))
                .input(fluids.in(
                        MaterialHelper.materialFluidSupplier(
                                BuiltinTopoMaterials.SULFURIC_ACID, BuiltinTopoMaterialForms.SOLUTION),
                        GATE_FLUID_MB))
        ...
        BuiltinTopoRecipeTypes.ELECTROLYZER.recipe("resonance_chamber_plate")
        ...
        BuiltinTopoRecipeTypes.HIGH_PRESSURE_CRYSTALLIZER.recipe("lumen_core_tune")
    ...
    private static ResourceKey<Recipe<?>> recipeKey(String path) {
        return ResourceKey.create(Registries.RECIPE, OfficialTopoPlugin.INSTANCE.recipe().id(path));
    }
}

...
public record ScalarResourcePortMetadata(
    ...
    public static final AttachmentType<ScalarResourcePortMetadata> TYPE = OfficialTopoPlugin.INSTANCE.machine().attachmentType("scalar_resource_port", ScalarResourcePortMetadata.class);

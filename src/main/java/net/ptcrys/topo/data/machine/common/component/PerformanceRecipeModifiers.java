...
import net.ptcrys.topo.data.machine.MachineTier;
...
public final class PerformanceRecipeModifiers {
    ...
    public static final class EnergyTierModifier extends MachineComponent implements RecipeModifier {
        ...
        private static ComponentMount<EnergyTierModifier> mount(MachineTier tier, boolean scaleDuration) {
            ...
            Component title = BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_CONSUMER_ENERGY_NAME.getComponent(level);
        ...
        public UIElement createDetailsUi() {
            return consumerLcd(
                    BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_SCALAR_ENERGY.getComponent(),
                    durationFactor,
                    powerFactor,
                    scaleDuration,
                    BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_TOTAL_ENERGY.getComponent());
        }

        @Override
        public TopoRecipe modify(TopoRecipe recipe) {
            ScalarRecipeCapability capability = BuiltinTopoResourceIntegrations.ENERGY.recipeCapability();
            if (scaleDuration) {
    ...
    public static final class HeatTierModifier extends MachineComponent implements RecipeModifier {
        ...
        private static ComponentMount<HeatTierModifier> mount(MachineTier tier, Role role) {
            ...
            Component title = switch (role) {
                case CONSUME, CONSUME_AMOUNTS -> BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_CONSUMER_HEAT_NAME.getComponent(level);
                case OUTPUT_AMOUNTS -> BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_PRODUCER_HEAT_NAME.getComponent(level);
            };
            Component description = switch (role) {
                ...
                case OUTPUT_AMOUNTS -> RecipeModifierDescriptionLine.single(
                        BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_HEAT_OUT.getComponent(),
                        powerFactor,
        ...
        public UIElement createDetailsUi() {
            ...
            return switch (role) {
                case CONSUME, CONSUME_AMOUNTS -> consumerLcd(
                        BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_SCALAR_HEAT.getComponent(),
                        durationFactor,
                        powerFactor,
                        scaleDuration,
                        BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_TOTAL_HEAT_COST.getComponent());
                case OUTPUT_AMOUNTS -> outputAmountsLcd(
                        BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_SCALAR_HEAT.getComponent(),
                        BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_HEAT_OUT.getComponent(),
                        durationFactor,
                        powerFactor,
                        BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_TOTAL_HEAT.getComponent());
            };
        }

        @Override
        public TopoRecipe modify(TopoRecipe recipe) {
            ScalarRecipeCapability capability = BuiltinTopoResourceIntegrations.HEAT.recipeCapability();
            return switch (role) {
    ...
    public static final class AdvancedEnergyTierModifier extends MachineComponent implements RecipeModifier {
        ...
        private static ComponentMount<AdvancedEnergyTierModifier> mount(
            ...
            double durationFactor = CONSUMER_DURATION[i];
            double powerFactor = CONSUMER_POWER[i];
            Component title = BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_CONSUMER_ADV_ENERGY_NAME.getComponent(level);
            Component description = RecipeModifierDescriptionLine.consumer(durationFactor, powerFactor, scaleDuration);
            return KEY.mount(
        ...
        public UIElement createDetailsUi() {
            return consumerLcd(
                    BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_SCALAR_ADVANCED_ENERGY.getComponent(),
                    durationFactor,
                    powerFactor,
                    scaleDuration,
                    BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_TOTAL_ADV_ENERGY.getComponent());
        }

        @Override
        public TopoRecipe modify(TopoRecipe recipe) {
            ScalarRecipeCapability capability = BuiltinTopoResourceIntegrations.ADVANCED_ENERGY.recipeCapability();
            if (scaleDuration) {
                return recipe.withScaledCapabilityPerformance(capability, durationFactor, powerFactor);
            }
            return recipe.withScaledCapabilityAmounts(capability, powerFactor);
    ...
    public static final class EnergyGenerationTierModifier extends MachineComponent implements RecipeModifier {
        ...
        public static ComponentMount<EnergyGenerationTierModifier> of(MachineTier tier) {
            ...
            Component title = BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_PRODUCER_ENERGY_NAME.getComponent(level);
            Component description = RecipeModifierDescriptionLine.producer(
                    BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_GENERATION.getComponent(),
                    durationFactor,
                    yieldFactor);
            return KEY.mount(
        ...
        public UIElement createDetailsUi() {
            return producerLcd(
                    ...
                    durationFactor,
                    yieldFactor,
                    BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_TOTAL_GENERATION.getComponent());
        }
    ...
    public static final class HeatGenerationTierModifier extends MachineComponent implements RecipeModifier {
        ...
        public static ComponentMount<HeatGenerationTierModifier> of(MachineTier tier) {
            ...
            double durationFactor = PRODUCER_DURATION[i];
            double yieldFactor = PRODUCER_YIELD[i];
            Component title = BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_PRODUCER_HEAT_NAME.getComponent(level);
            Component description = RecipeModifierDescriptionLine.producer(
                    BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_HEAT_OUT.getComponent(),
                    durationFactor,
                    yieldFactor);
    ...
    public static final class EnergyConversionTierModifier extends MachineComponent implements RecipeModifier {
        ...
        public static ComponentMount<EnergyConversionTierModifier> of(MachineTier tier) {
            ...
            Component title = BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_CONVERTER_NAME.getComponent(level);
        ...
        public UIElement createDetailsUi() {
            ...
            return MachineUiContainerTemplate.INSTANCE
                    ...
                    .addStaticEntry(
                            ...
                            LcdData.LED_RUNNING)
                    .addStaticEntry(
                            BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_SPEED.getComponent(),
                            factor(speed),
                            LcdData.LED_WAITING)
                    .addStaticEntry(
                            BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_TOTAL_INPUT.getComponent(),
                            factor(inCraft),
                            LcdData.LED_WAITING)
                    .addStaticEntry(
                            BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_TOTAL_OUTPUT.getComponent(),
                            factor(outCraft),
                            LcdData.LED_WAITING)
                    .addStaticEntry(
                            BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_OUTPUT_RATE.getComponent(),
        ...
        @Override
        public TopoRecipe modify(TopoRecipe recipe) {
            RecipeCapability<?, ?> energy = BuiltinTopoResourceIntegrations.ENERGY.recipeCapability();
            RecipeCapability<?, ?> adv = BuiltinTopoResourceIntegrations.ADVANCED_ENERGY.recipeCapability();
     ...
     * {@link TopoRecipe#withParallel(long)} applies the smallest bound. Duration is unchanged —
    ...
    public static final class ParallelModifier extends MachineComponent implements RecipeModifier {
        ...
        public static ComponentMount<ParallelModifier> of(long maxParallels) {
            ...
            Component title = BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_PARALLEL_TITLE.getComponent();
            Component description = RecipeModifierDescriptionLine.single(
                    BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_PARALLEL.getComponent(),
                    maxParallels,
                    RecipeModifierDescriptionLine.primaryRgb());
            return KEY.mount(
        ...
        public UIElement createDetailsUi() {
            return MachineUiContainerTemplate.INSTANCE
                    ...
                    .addStaticEntry(
                            ...
                            LcdData.LED_RUNNING)
                    .addStaticEntry(
                            BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_EFFECT.getComponent(),
                            BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_PARALLEL_EFFECT.getComponent(),
                            LcdData.LED_TEXT)
                    .addStaticEntry(
                            BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_THROUGHPUT.getComponent(),
                            BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_PARALLEL_THROUGHPUT.getComponent(
                                    maxParallels),
                            LcdData.LED_TEXT);
        }
    ...
    private static UIElement consumerLcd(
        ...
        LcdData lcd = MachineUiContainerTemplate.INSTANCE
                .createLcdData(LcdData.Orientation.VERTICAL)
                .addStaticEntry(
                        BuiltinTopoMachineUiLang.UI_RECIPE_MODIFIER_ATTR_AFFECTS.getComponent(),
                        scalarName,
                        LcdData.LED_TEXT);
        if (scaleDuration) {
            lcd.addStaticEntry(

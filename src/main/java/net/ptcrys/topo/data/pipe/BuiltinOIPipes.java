...
import static net.ptcrys.topo.data.pipe.BuiltinOIPipeDistributionStrategies.BY_DISTANCE;
import static net.ptcrys.topo.data.pipe.BuiltinOIPipeDistributionStrategies.EQUAL_SPLIT;
import static net.ptcrys.topo.data.pipe.BuiltinOIPipeDistributionStrategies.ROUND_ROBIN;
 ...
 *
 * <p>
 * Every resource kind uses the original OI full-face texture language under
 ...
 */
public final class BuiltinOIPipes {

    private static final PipeResourceProfile ITEM_PROFILE = new PipeResourceProfile(
            BuiltinOIResourceIntegrations.ITEM.resourceType(), OiCompactNumber::formatCompact,
            BuiltinOIPipeFilterAdapters.ITEM);
    private static final PipeResourceProfile FLUID_PROFILE = new PipeResourceProfile(
            BuiltinOIResourceIntegrations.FLUID.resourceType(), OiCompactNumber::formatCompactBuckets,
            BuiltinOIPipeFilterAdapters.FLUID);
    ...
    private static final PipeResourceProfile ENERGY_PROFILE = new PipeResourceProfile(
            BuiltinOIResourceIntegrations.ENERGY.resourceType(), OiCompactNumber::formatCompact, null);
    private static final PipeResourceProfile ADVANCED_ENERGY_PROFILE = new PipeResourceProfile(
            BuiltinOIResourceIntegrations.ADVANCED_ENERGY.resourceType(), OiCompactNumber::formatCompact, null);
    private static final PipeResourceProfile HEAT_PROFILE = new PipeResourceProfile(
            BuiltinOIResourceIntegrations.HEAT.resourceType(), OiCompactNumber::formatCompact, null);

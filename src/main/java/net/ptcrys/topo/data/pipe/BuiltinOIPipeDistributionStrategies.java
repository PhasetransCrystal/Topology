 ...
 * expressed at the pipe registration sites ({@code BuiltinOIPipes}) through
 ...
 */
public final class BuiltinOIPipeDistributionStrategies {
    ...
    private BuiltinOIPipeDistributionStrategies() {}
    ...
    public enum DistanceOrder implements StringRepresentable {
        ...
        public LangKey nameLang() {
            return BuiltinOIPipeLang.distanceOrder(this);
        }
        ...
        public void contributeConfigUi(PipePortUiCollector collector, PipePortAccess access) {
            ...
            for (DistanceOrder order : orders) {
                ...
                buttons[ordinal] = collector.intChoiceButton(
                        "oi_pipe_port_order_" + order.getSerializedName(),
                        order.displayName(),
                        selectedOrder,
                        ordinal,
                        label -> labels[ordinal] = label);
            }
            collector.addRow(collector.labeledRow("oi_pipe_port_order_row",
                    BuiltinOIPipeLang.UI_PIPE_PORT_DISTANCE_ORDER.getComponent(), buttons));
        }
    }

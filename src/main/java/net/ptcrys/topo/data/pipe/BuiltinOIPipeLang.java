 ...
 * {@link OIApiLang} and re-exported here for data-layer convenience.
 */
public final class BuiltinOIPipeLang {

    private static final LangDomainRegistration LANG = OfficialOIPlugin.INSTANCE.lang();

    public static final LangKey PIPE_SIDE_MODE = OIApiLang.PIPE_SIDE_MODE;
    public static final LangKey PIPE_SIDE_DOWN = OIApiLang.PIPE_SIDE_DOWN;
    public static final LangKey PIPE_SIDE_UP = OIApiLang.PIPE_SIDE_UP;
    public static final LangKey PIPE_SIDE_NORTH = OIApiLang.PIPE_SIDE_NORTH;
    public static final LangKey PIPE_SIDE_SOUTH = OIApiLang.PIPE_SIDE_SOUTH;
    public static final LangKey PIPE_SIDE_WEST = OIApiLang.PIPE_SIDE_WEST;
    public static final LangKey PIPE_SIDE_EAST = OIApiLang.PIPE_SIDE_EAST;
    public static final LangKey PIPE_MODE_AUTO = OIApiLang.PIPE_MODE_AUTO;
    public static final LangKey PIPE_MODE_DISABLED = OIApiLang.PIPE_MODE_DISABLED;
    public static final LangKey PIPE_MODE_EXTRACT = OIApiLang.PIPE_MODE_EXTRACT;
    ...
    public static final LangKey PIPE_STRATEGY_SELECTED = OIApiLang.PIPE_STRATEGY_SELECTED;
    ...
    /** Display handle for {@link BuiltinOIPipeDistributionStrategies.DistanceOrder}. */
    public static LangKey distanceOrder(BuiltinOIPipeDistributionStrategies.DistanceOrder order) {
        return switch (order) {

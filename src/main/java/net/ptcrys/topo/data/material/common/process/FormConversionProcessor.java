...
import net.ptcrys.topo.data.material.common.ItemAdditiveData;
...
public final class FormConversionProcessor extends MaterialPostProcessor {
    ...
    private FormConversionProcessor(Identifier id, TopoRecipeType<TopoRecipe> recipeType,
    ...
    public void process(Material material) {
        ...
        ScalarRecipeCapability energy = energyPerTick > 0 ? BuiltinTopoResourceIntegrations.ENERGY.recipeCapability() : null;
        ScalarRecipeCapability heat = heatPerTick > 0 ? BuiltinTopoResourceIntegrations.HEAT.recipeCapability() : null;
    ...
    public static final class Builder {
        ...
        private TopoRecipeType<TopoRecipe> recipeType;
        ...
        public Builder recipeType(TopoRecipeType<TopoRecipe> recipeType) {
            this.recipeType = recipeType;
            return this;
        }
    ...
    public static final class StepBuilder {
        ...
        private static int units(List<Stack> stacks) {
            ...
            for (Stack stack : stacks) {
                var amount = stack.form.strategy().data(BuiltinTopoFormDataTypes.AMOUNT);
                if (amount.isEmpty()) {
                    return -1;
                }

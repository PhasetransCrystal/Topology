...
import net.ptcrys.topo.data.material.common.form.BlockForm;
import net.ptcrys.topo.data.material.common.form.FluidForm;
import net.ptcrys.topo.data.material.common.form.ItemForm;
import net.ptcrys.topo.data.material.common.form.NonPlaceableBlockItem;
import net.ptcrys.topo.data.material.common.render.GtmMaterialBlockRender;
import net.ptcrys.topo.data.material.common.render.TintedTemplate;
import net.ptcrys.topo.data.material.common.render.WireTierBlockRender;

import net.minecraft.world.level.block.Blocks;

import static net.ptcrys.topo.data.material.BuiltinTopoFormDataTypes.AMOUNT;
...
import static net.ptcrys.topo.data.material.common.render.TintedTemplate.flat;
import static net.ptcrys.topo.data.material.common.render.TintedTemplate.opaque;
import static net.ptcrys.topo.data.material.common.render.TintedTemplate.tinted;
import static net.ptcrys.topo.data.material.common.render.TintedTemplate.translucent;

/** Material forms used by the current design document. */
public final class BuiltinTopoMaterialForms {
    // ---- Ore block forms --------------------------------------------------------------------

    public static final MaterialForm ORE = OfficialTopoPlugin.INSTANCE.material().form("ore")
            .lang("Ore", "矿石")
            .strategy(BlockForm.builder()
                    .registryPath("%s_ore")
                    .displayName("%s Ore", "%s矿石")
                    .commonTag("ores")
                    .creativeTab(BuiltinTopoCreativeTabs.MATERIALS.getKey())
    ...
    public static final MaterialForm DEEPSLATE_ORE = OfficialTopoPlugin.INSTANCE.material().form("deepslate_ore")
    ...
    public static final MaterialForm NETHERRACK_ORE = OfficialTopoPlugin.INSTANCE.material().form("netherrack_ore")
    ...
    public static final MaterialForm GEM = OfficialTopoPlugin.INSTANCE.material().form("gem")
            .lang("Gem", "宝石")
    ...
    public static final MaterialForm INGOT = OfficialTopoPlugin.INSTANCE.material().form("ingot")
            .lang("Ingot", "锭")
            .strategy(ItemForm.builder()
    ...
    public static final MaterialForm NUGGET = OfficialTopoPlugin.INSTANCE.material().form("nugget")
            .lang("Nugget", "粒")
            .strategy(ItemForm.builder()
    ...
    public static final MaterialForm BLOCK = OfficialTopoPlugin.INSTANCE.material().form("block")
            .lang("Block", "块")
            .strategy(BlockForm.builder()
    ...
    public static final MaterialForm SOLUTION = OfficialTopoPlugin.INSTANCE.material().form("solution")
            .lang("Solution", "溶液")
    ...
    public static final MaterialForm GAS = OfficialTopoPlugin.INSTANCE.material().form("gas")
            .lang("Gas", "气体")
            .strategy(FluidForm.builder()
                    .registryPath("%s_gas")
    ...
    private BuiltinTopoMaterialForms() {}
    ...
    private static MaterialForm dustForm(
        ...
        return OfficialTopoPlugin.INSTANCE.material().form(id)

package net.ptcrys.topo.data.data.visual;
...
import net.ptcrys.topo.api.api.visual.ConnectedTextureCasingModel;
import net.ptcrys.topo.api.api.visual.ConnectedTextureHatchModel;
import net.ptcrys.topo.api.api.visual.ConnectedTextureMachineModel;

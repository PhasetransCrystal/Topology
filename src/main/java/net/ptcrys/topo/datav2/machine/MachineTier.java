...
public enum MachineTier {
    ...
    MachineTier(int ratedPowerMultiplier) {
        ...
        this.shellMaterial = new MachineShellMaterial(
                OfficialOIPlugin.INSTANCE.machine().id(hullTextureFolder + "/bottom"),
                OfficialOIPlugin.INSTANCE.machine().id(hullTextureFolder + "/side"),
                OfficialOIPlugin.INSTANCE.machine().id(hullTextureFolder + "/top"));
    }

...
import net.ptcrys.topo.datav2.machine.common.render.CtmMachineRenderType;
import net.ptcrys.topo.datav2.machine.common.render.FormedActiveMachineRenderType;
import net.ptcrys.topo.datav2.machine.common.render.ShellMachineRenderType;
import net.ptcrys.topo.datav2.machine.common.render.ShellOverlayMachineRenderType;

/** Builtin machine block render types via {@link OfficialOIPlugin#machine()}. */
public final class BuiltinOIMachineRenderTypes {
    ...
    private BuiltinOIMachineRenderTypes() {}

...
public final class PreviewRecipeModifierComponent extends MachineComponent implements RecipeModifier {
    ...
    public static ComponentMount<PreviewRecipeModifierComponent> parallel() {
        Component title = BuiltinOIMachineUiLang.UI_RECIPE_MODIFIER_PREVIEW_PARALLEL_TITLE.getComponent();
        Component description = RecipeModifierDescriptionLine.single(
                BuiltinOIMachineUiLang.UI_RECIPE_MODIFIER_PREVIEW_ATTR_PARALLEL.getComponent(),
                2.0d,
    ...
    public static ComponentMount<PreviewRecipeModifierComponent> overclock() {
        Component title = BuiltinOIMachineUiLang.UI_RECIPE_MODIFIER_PREVIEW_OVERCLOCK_TITLE.getComponent();
    ...
    public static ComponentMount<PreviewRecipeModifierComponent> catalyst() {
        Component title = BuiltinOIMachineUiLang.UI_RECIPE_MODIFIER_PREVIEW_CATALYST_TITLE.getComponent();
        Component description = RecipeModifierDescriptionLine.singleValue(
                BuiltinOIMachineUiLang.UI_RECIPE_MODIFIER_PREVIEW_ATTR_BONUS.getComponent(),
    ...
    private static UIElement parallelLcd() {
        return MachineUiContainerTemplate.INSTANCE
                ...
                .addStaticEntry(
                        ...
                        LcdData.LED_RUNNING)
                .addStaticEntry(
                        BuiltinOIMachineUiLang.UI_RECIPE_MODIFIER_PREVIEW_ATTR_MODE.getComponent(),
                        BuiltinOIMachineUiLang.UI_RECIPE_MODIFIER_PREVIEW_PARALLEL_MODE.getComponent(),
                        LcdData.LED_TEXT);
    }
    ...
    private static UIElement overclockLcd() {
        return MachineUiContainerTemplate.INSTANCE
                .createLcdData(LcdData.Orientation.VERTICAL)
                .addStaticEntry(
                        BuiltinOIMachineUiLang.UI_RECIPE_MODIFIER_PREVIEW_ATTR_OC.getComponent(),
                        BuiltinOIMachineUiLang.UI_RECIPE_MODIFIER_PREVIEW_OVERCLOCK_MODE.getComponent(),
                        LcdData.LED_WAITING)
                .addStaticEntry(

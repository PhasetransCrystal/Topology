...
import net.ptcrys.topo.apiv2.ore.OreDimensionRule;
import net.ptcrys.topo.apiv2.ore.OreEnvironment;
import net.ptcrys.topo.apiv2.ore.OreEnvironments;
 ...
 */
public final class BuiltinOIOreEnvironments {
    ...
    private static final OreDimensionRule OVERWORLD = new OreDimensionRule(
            Level.OVERWORLD, BiomeTags.IS_OVERWORLD, BuiltinOIOreLang.DIM_OVERWORLD);
    private static final OreDimensionRule NETHER = new OreDimensionRule(
            Level.NETHER, BiomeTags.IS_NETHER, BuiltinOIOreLang.DIM_NETHER);

    private static final OreHostRule STONE_HOST = new OreHostRule(
            STONE_ORE_REPLACEABLES, BuiltinOIMaterialForms.ORE, BuiltinOIOreLang.HOST_STONE);
    private static final OreHostRule DEEPSLATE_HOST = new OreHostRule(
            DEEPSLATE_ORE_REPLACEABLES, BuiltinOIMaterialForms.DEEPSLATE_ORE, BuiltinOIOreLang.HOST_DEEPSLATE);
    private static final OreHostRule NETHERRACK_HOST = new OreHostRule(
            BASE_STONE_NETHER, BuiltinOIMaterialForms.NETHERRACK_ORE, BuiltinOIOreLang.HOST_NETHERRACK);
    ...
    private BuiltinOIOreEnvironments() {}

...
import net.ptcrys.topo.datav2.material.common.process.ManualForgeHammerProcessor;
import net.ptcrys.topo.datav2.material.common.process.MetalComponentFormProcessor;
import net.ptcrys.topo.datav2.material.common.process.MetalFormProcessor;
import net.ptcrys.topo.datav2.material.common.process.OreProcessing12xProcessor;
import net.ptcrys.topo.datav2.material.common.process.OreProcessing2xProcessor;
import net.ptcrys.topo.datav2.material.common.process.OreProcessing3xProcessor;
import net.ptcrys.topo.datav2.material.common.process.OreProcessing4xProcessor;
import net.ptcrys.topo.datav2.material.common.process.OreProcessing6xProcessor;
import net.ptcrys.topo.datav2.material.common.process.WireTierFormProcessor;

/** Builtin material post processors used by wildcard production lines. */
public final class BuiltinOIMaterialPostProcessors {
    ...
    private BuiltinOIMaterialPostProcessors() {}

...
import net.ptcrys.topo.datav2.material.common.ProcessDieItem;
 ...
 */
public final class BuiltinOIProcessDies {
    ...
    private static ItemEntry<ProcessDieItem> die(
        ...
        var core = OfficialOIPlugin.INSTANCE.registry();
        ...
        ItemEntry<ProcessDieItem> template = builder
                .addTab(BuiltinOICreativeTabs.MATERIALS.getKey())
                .addTag(DIES)
                .register();

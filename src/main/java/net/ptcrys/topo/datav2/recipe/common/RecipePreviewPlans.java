 ...
 * {@code OIRecipeTypes.installPreviewPlans(RecipePreviewPlans::canonical)}；没有任何合格机器的
...
public final class RecipePreviewPlans {
    ...
    public static RecipePreviewPlan canonical(OIRecipeType<?> recipeType) {
    ...
    private static @Nullable MachineDefinition selectCanonicalMachine(OIRecipeType<?> recipeType) {
    ...
    private static int recipeTypeFootprint(MachineDefinition definition, OIRecipeType<?> recipeType) {

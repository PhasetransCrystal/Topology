 ...
 */
public final class CombustionGeneratorRecipeType extends OIRecipeType<OIRecipe> {

    public static final int ENERGY_PER_BURN_TICK = 20;
    private static final String VIRTUAL_FUEL_PREFIX = "combustion_generator/fuel/";
    private static final List<ProductionLine> ENERGY_LINE = List.of(BuiltinOIProductionLines.ENERGY);
    ...
    private RecipeHolder<OIRecipe> fuelHolder(ItemStack fuel, int burnTicks) {
        return new RecipeHolder<>(ResourceKey.create(Registries.RECIPE, fuelRecipeId(fuel.getItem())),
                fuelRecipe(fuel, burnTicks));
    }

    private OIRecipe fuelRecipe(ItemStack fuel, int burnTicks) {
        ...
        return createRecipe(
                ...
                new OIRecipe.OutputEntry<?>[] {
                        new OIRecipe.OutputEntry<>(energy, List.of((long) ENERGY_PER_BURN_TICK))
                },
                burnTicks,
                ENERGY_LINE);
    }

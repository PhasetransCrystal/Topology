package net.ptcrys.topo.client.machine.ui.tooltip;
 ...
 * ({@code TopoMachineBlockItem}) and skips stacks whose component is already gathered — identity
...
public final class TopoTooltipComponentInjector {

    private TopoTooltipComponentInjector() {}

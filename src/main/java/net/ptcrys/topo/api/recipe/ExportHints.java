...
/**
 * Side-channel for write projection ({@link ExportedRecipeAdapter}). Not part of {@link TopoRecipe}
 * codec — builders assemble hints, then {@link TopoRecipeType#exportRecipe} hands them to the adapter.
 *
 * <p>
...
public record ExportHints(
    ...
    /** Deferred ingredient identity for export + Topo mirror minting. */

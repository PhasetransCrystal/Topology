...
import net.ptcrys.topo.api.machine.ui.MachineUiContainerTemplate.ButtonGroupStyle
import net.ptcrys.topo.api.machine.ui.MachineUiContainerTemplate.CardStyle
import net.ptcrys.topo.api.machine.ui.MachineUiContainerTemplate.createBox
                ...
                if (component.hasLiveVisibility()) {
                    ...
                    liveVisibilityAnchors.add(
                        BindableValue(true).apply {
                            setId("topo_side_card_live_${component.key()}")
                            setDisplay(false)
                            bind(

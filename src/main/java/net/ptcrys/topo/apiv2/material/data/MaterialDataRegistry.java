 ...
 * {@link net.ptcrys.topo.apiv2.plugin.MaterialDomainRegistration#dataType}.
 */
public final class MaterialDataRegistry {
    ...
    /**
     * Single write entry. Used by {@link net.ptcrys.topo.apiv2.plugin.MaterialDomainRegistration} and

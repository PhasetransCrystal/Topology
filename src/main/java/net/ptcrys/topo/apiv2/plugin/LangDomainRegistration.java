...
/**
 * Sole lang-domain registration entry for one {@link OIPlugin}. Full i18n keys are always
...
public final class LangDomainRegistration {
    ...
    private LangDomainRegistration(OIPlugin plugin, RegistryCore registry) {
        this.plugin = Objects.requireNonNull(plugin, "plugin");
        this.registry = Objects.requireNonNull(registry, "registry");
    }

    public static LangDomainRegistration of(OIPlugin plugin) {

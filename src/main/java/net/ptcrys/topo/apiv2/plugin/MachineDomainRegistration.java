...
/**
 * Sole machine-domain registration entry for one {@link OIPlugin}. Paths are bare; namespace and
...
public final class MachineDomainRegistration {
    ...
    private MachineDomainRegistration(OIPlugin plugin, RegistryCore registry) {
        this.plugin = Objects.requireNonNull(plugin, "plugin");
        this.registry = Objects.requireNonNull(registry, "registry");
    }

    public static MachineDomainRegistration of(OIPlugin plugin) {

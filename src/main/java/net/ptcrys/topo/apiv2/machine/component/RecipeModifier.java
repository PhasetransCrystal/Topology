 ...
 * {@link #modify(OIRecipe, MachineBlockEntity)}. Dynamic parallel is declared separately through
...
public interface RecipeModifier {
     ...
     */
    OIRecipe modify(OIRecipe recipe);

    /**
     * Context-aware fold. Dynamic parallel probes machine inputs here. Default: {@link #modify(OIRecipe)}.
     */
    default OIRecipe modify(OIRecipe recipe, @Nullable MachineBlockEntity machine) {

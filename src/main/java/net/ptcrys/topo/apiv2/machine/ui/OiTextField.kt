...
/**
 * OI text field: LDLib2 [TextField] with system-clipboard paste.
 *
 * Upstream Ctrl+V only reads LDLib's in-process [com.lowdragmc.lowdraglib2.editor.ClipboardManager],
 * which is empty after OS / `keyboardHandler.setClipboard` copies. We handle paste here so OI does
 * not need a LDLib mixin or a forked library build.
 */
class OiTextField : TextField() {

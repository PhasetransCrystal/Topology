...
public final class RecipeSearchPool {
    ...
    @Nullable
    RecipeHolder<? extends OIRecipe> rememberedSearch(
                                                      MachineBlockEntity machine, OIRecipeType<?> recipeType) {
    ...
    void rememberSuccessfulStart(
                                 OIRecipeType<?> recipeType, RecipeHolder<? extends OIRecipe> holder, long searchRevision) {
        RememberedSearch recent = recentSearch;
    ...
    void noteRememberedStartFailure(OIRecipeType<?> recipeType, RecipeHolder<? extends OIRecipe> holder) {
        RememberedSearch recent = recentSearch;
    ...
    private static final class RememberedSearch {
        ...
        private @Nullable OIRecipeType<?> hitType;
        private @Nullable RecipeHolder<? extends OIRecipe> holder;
        private long searchRevision;
        private int probeFailures;

        boolean references(OIRecipeType<?> type, RecipeHolder<? extends OIRecipe> candidate) {
            return hitType == type && holder != null && holder.id().equals(candidate.id());
        }

        RecipeHolder<? extends OIRecipe> holder() {
            return Objects.requireNonNull(holder, "remembered recipe holder");
        }

        boolean isFor(OIRecipeType<?> type) {
            return hitType == type;
        }
        ...
        void refresh(OIRecipeType<?> type, RecipeHolder<? extends OIRecipe> candidate, long revision) {
            hitType = type;
            holder = candidate;

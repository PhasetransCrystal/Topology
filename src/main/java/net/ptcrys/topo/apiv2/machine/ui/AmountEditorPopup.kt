...
object AmountEditorPopup {
    ...
    private fun buildAmountField(state: AmountState): TextField {
        val amountField = OiTextField().apply {
            setId("oi_amount_popup_text_field")
            layout {
    ...
    private fun buildButtonRow(state: AmountState, amountField: TextField, refs: MutableList<Pair<Button, Long>>): UIElement = MachineUiLayout.row(
        ...
        id = "oi_amount_popup_step_row",
    ) {
        add(
            stepGroup(
                "oi_amount_popup_minus_group",
                listOf(
                    Triple("oi_amount_popup_minus_100", "-100", -100L),
                    Triple("oi_amount_popup_minus_10", "-10", -10L),
                    Triple("oi_amount_popup_minus_1", "-1", -1L),
                ),
                state,
                amountField,
                refs,
        ...
        add(
            stepGroup(
                "oi_amount_popup_plus_group",
                listOf(
                    Triple("oi_amount_popup_plus_1", "+1", +1L),
                    Triple("oi_amount_popup_plus_10", "+10", +10L),
                    Triple("oi_amount_popup_plus_100", "+100", +100L),
                ),
                state,
                amountField,
                refs,
    ...
    private fun buildActionRow(onConfirm: () -> Unit, onCancel: () -> Unit): UIElement = MachineUiLayout.row(
        ...
        alignItems = AlignItems.CENTER,
        justifyContent = AlignContent.SPACE_BETWEEN,
        id = "oi_amount_popup_action_row",
    ) {
        add(
            actionButton(
                "oi_amount_popup_cancel",
                BuiltinOIMachineUiLang.UI_AMOUNT_POPUP_CANCEL.getComponent(),
                onCancel,
            ),
        )
        add(
            actionButton(
                "oi_amount_popup_confirm",
                BuiltinOIMachineUiLang.UI_AMOUNT_POPUP_CONFIRM.getComponent(),
                onConfirm,
            ),
        )
    }

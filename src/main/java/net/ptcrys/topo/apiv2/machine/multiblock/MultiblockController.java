...
import net.ptcrys.topo.apiv2.machine.component.RecipeCondition;
...
import net.ptcrys.topo.apiv2.machine.multiblock.pattern.CompiledBlueprint;
import net.ptcrys.topo.apiv2.machine.multiblock.pattern.CompiledSnapshot;
...
import net.ptcrys.topo.apiv2.machine.multiblock.pattern.RepeatResolution;
...
public final class MultiblockController extends MachineTicker {
    ...
    private RecipeModifier memberFoldModifier(@Nullable RecipeLogic context) {
        ...
        return new RecipeModifier() {
            ...
            public Component title() {
                return OIApiLang.UI_RECIPE_MODIFIER_MULTIBLOCK_NAME.getComponent();
            }

            @Override
            public Component description() {
                return OIApiLang.UI_RECIPE_MODIFIER_MULTIBLOCK_DESC.getComponent();
            }
            ...
            public UIElement createDetailsUi() {
                return MachineUiContainerTemplate.INSTANCE
                        ...
                        .addStaticEntry(
                                OIApiLang.UI_RECIPE_MODIFIER_ATTR_SCOPE.getComponent(),
                                OIApiLang.UI_RECIPE_MODIFIER_MULTIBLOCK_SCOPE.getComponent(),
                                LcdData.LED_TEXT)
                        .addStaticEntry(
                                OIApiLang.UI_RECIPE_MODIFIER_ATTR_EFFECT.getComponent(),
                                OIApiLang.UI_RECIPE_MODIFIER_MULTIBLOCK_EFFECT.getComponent(),
                                LcdData.LED_RUNNING);
            }

            @Override
            public @NonNull OIRecipe modify(@NonNull OIRecipe recipe) {
                return foldMemberRecipeModifiers(recipe, memberModifiers);
            }

            @Override
            public @NonNull OIRecipe modify(
                                            @NonNull OIRecipe recipe, @Nullable MachineBlockEntity host) {
                return foldMemberRecipeModifiers(recipe, memberModifiers);
            }
    ...
    private OIRecipe foldMemberRecipeModifiers(
                                               OIRecipe recipe, List<ServiceMatch<RecipeModifier>> memberModifiers) {
     ...
     * {@link net.ptcrys.topo.apiv2.machine.resource.RecipeSearchPoolRouter} — same-pool handlers merge there.

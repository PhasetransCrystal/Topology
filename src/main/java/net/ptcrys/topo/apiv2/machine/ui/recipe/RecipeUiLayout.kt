...
object RecipeUiLayout {
    ...
    @JvmStatic
    fun buildRecipeIoRow(recipeType: OIRecipeType<*>, slotCounts: Map<SlottedRecipeCapability<*, *, *>, SlotPlan>, slotFactory: (RecipeRole, Int) -> UIElement, progressBinder: (ProgressBar) -> Unit): UIElement = UIElement().apply {
        setId("oi_recipe_io_row")
    ...
    @JvmStatic
    fun buildProgressBar(recipeType: OIRecipeType<*>, progressBinder: (ProgressBar) -> Unit): ProgressBar {
        ...
        val bar = ProgressBar()
        bar.setId("oi_recipe_progress_bar")
        bar.layout {
    ...
    private fun buildScalarConversionFan(): UIElement = UIElement().apply {
        setId("oi_recipe_scalar_conversion_fan")
        layout {

...
import net.ptcrys.topo.datav2.ore.common.display.OreVeinPanels;
 ...
 */
public final class OIOreVeinJeiCategory extends ModularUIRecipeCategory<OreVein> {
    ...
    public OIOreVeinJeiCategory(IGuiHelper guiHelper) {
        super(OIOreVeinJeiCategory::buildPreview);
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(Items.IRON_ORE));
        this.title = BuiltinOIOreLang.CATEGORY.getComponent();
    }
